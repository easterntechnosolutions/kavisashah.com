...
class website
{
	...
	/*	if($earr['homeimage'] != "")
		{
			$form->addElement(new Element_HTML('<img src="'.DIR_WS_LOGO_PATH.$earr['homeimage'].'" height = "100px" width ="100px" position: relative;" ><br>'));
		}
		$form->addElement(new Element_HTML('<label>Note : width= 900px , height= 600px require jpg file</label><br>'));	
		$form->addElement(new Element_File("Brochure (PDF):", "homeimage", array(
			"placeholder" => "Home Page Popup Image"
			)));
		...
		$form->addElement(new Element_Textbox("Dribbble:", "dribbble", array(
		...
		$form->addElement(new Element_TinyMCE("My Tools:", "address", array(
			"placeholder" => "My Tools",
			"value" => $earr['address']
			)));

        $form->addElement(new Element_TinyMCE("Work:", "address2", array(
            "placeholder" => "Work",
            "value" => $earr['address2']
        )));

        $form->addElement(new Element_TinyMCE("Education", "address3", array(
            "placeholder" => "Education",
            "value" => $earr['address3']
        )));
        $form->addElement(new Element_TinyMCE("Awards", "address4", array(
            "placeholder" => "Awards",
            "value" => $earr['address4']
        )));
	...
	function add()
	{
		...
		$social['dribbble'] = addslashes($_POST['dribbble']);
		...
		if($selarr['total'] > 0)
		{
			$sql = "Update website_master set
					...
					address2 = '".ets_db_real_escape_string(trim($_POST['address2']))."',
					address3 = '".ets_db_real_escape_string(trim($_POST['address3']))."',
					address4 = '".ets_db_real_escape_string(trim($_POST['address4']))."',
