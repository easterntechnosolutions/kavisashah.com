...
class slider
{
    function addForm()
    {
        ...
        $form->addElement(new Element_Textarea("Image Description:", "sliderDesc", array(
            "placeholder" => "Image Description"
        )));
        $form->addElement(new Element_Textbox("Button text:", "sliderBtn", array(
            "placeholder" => "Button text"
        )));

        $form->addElement(new Element_Textbox("Button Link:", "btnlink", array(
            "placeholder" => "Button Link"
        )));

        $form->addElement(new Element_File("Slider Image: <br>(2716 * 1235 pixels)", "image", array(
            "required" => 1,
            "placeholder" => "Photo"
        )));

        $form->addElement(new Element_File("Mobile Slider Image: <br>(1000 * 550 pixels)", "mobile_slider_image", array(
            "required" => 1,
    ...
    function add()
    {
        ...
        sliderDesc = '".ets_db_real_escape_string($_POST['sliderDesc'])."',
        sliderBtn = '".ets_db_real_escape_string($_POST['sliderBtn'])."',
        btnlink = '".ets_db_real_escape_string($_POST['btnlink'])."',     
		sliderPosition = 'H',		
		username = '".$username."',
		createdate= now(),
