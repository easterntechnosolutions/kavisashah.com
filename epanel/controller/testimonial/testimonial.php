...
class testimonial
{
	function addForm()
	{
        ...
        $form->addElement(new Element_File("Testimonial Image (512 × 512 pixels): <br>", "image", array(
            "placeholder" => "Photo"
        )));
	...
	function add()
	{
		...
		designation = '".ets_db_real_escape_string($_POST['designation'])."',
