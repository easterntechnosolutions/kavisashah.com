...
class workvideo
{
    function addForm()
    {
        ...
        $form->addElement(new Element_Hidden("action", "workvideo"));
        ...
        $form->addElement(new Element_Hidden("isFront","V"));
       ...
       /* $form->addElement(new Element_File("Products Image: ", "master_plan", array(
        ...
        $form->addElement(new Element_File("Product Detail Video <br> (Max Size: 2MB)", "galleryImage", array(
            "placeholder" => "Video"
        )));
        
        $form->addElement(new Element_File("Video 1 <br> (Max Size: 2MB)", "galleryImage1", array(
            "placeholder" => "Video"
        )));
        
        $form->addElement(new Element_File("Video 2 <br> (Max Size: 2MB)", "galleryImage2", array(
            "placeholder" => "Video"
        )));
    ...
    function editForm()
    {
        ...
        if (ets_db_num_rows($qry) > 0) {
            ...
            if ($rs["galleryImage"] != "") {
                ...
                $form->addElement(new Element_HTML('<video src="'.$thumbnail_path.'" width="30%" height="30%" "></video>'));
            ...
            if ($rs["galleryImage1"] != "") {
                ...
                $form->addElement(new Element_HTML('<video src="'.$thumbnail_path1.'" width="30%" height="30%" "></video>'));
            ...
            $form->addElement(new Element_File("Brand Image Grid 2 ", "galleryImage1", array(
             ...
             if ($rs["galleryImage2"] != "") {
                ...
                $form->addElement(new Element_HTML('<video src="'.$thumbnail_path2.'" width="30%" height="30%" "></video>'));
    ...
    function listData()
    {
        ...
        <script>
            $(document).ready(function () {
                var listURL = "helperfunc/workvideoList.php?workID=<?php echo $_REQUEST['workID']; ?>";
