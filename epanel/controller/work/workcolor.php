...
class workcolor
{
    function addForm()
    {
        ...
        $form->addElement(new Element_HTML("<legend>Color Palette Section</legend>"));
        $form->addElement(new Element_Hidden("controller", "work"));
        $form->addElement(new Element_Hidden("action", "workcolor"));
       ...
       /* $form->addElement(new Element_File("Products Image: ", "master_plan", array(
        ...
        $form->addElement(new Element_File("Color Image 1", "galleryImage", array(
            "placeholder" => "Image"
        )));
        ...
        $form->addElement(new Element_File("Color Image 2 ", "galleryImage1", array(
            "placeholder" => "Image"
        )));
        ...
        $form->addElement(new Element_File("Color Image 3 ", "galleryImage2", array(
            "placeholder" => "Image"
        )));
    ...
    function editForm()
    {
        ...
        if (ets_db_num_rows($qry) > 0) {
            ...
            if ($rs["galleryImage"] != "") {
                ...
                $form->addElement(new Element_HTML('<img src="'.$thumbnail_path.'" width="100" height="100" ">'));
            ...
            if ($rs["galleryImage1"] != "") {
                ...
                $form->addElement(new Element_HTML('<img src="'.$thumbnail_path1.'" width="100" height="100" ">'));
            ...
            $form->addElement(new Element_TinyMCE("User Flows & Wireframes:", "user_flows_des", array(
             ...
             if ($rs["galleryImage2"] != "") {
                ...
                $form->addElement(new Element_HTML('<img src="'.$thumbnail_path2.'" width="100" height="100" ">'));
    ...
    function listData()
    {
        ...
        <script>
            $(document).ready(function () {
                var listURL = "helperfunc/workcolorList.php?workID=<?php echo $_REQUEST['workID']; ?>";
