...
class worklogo
{
    function addForm()
    {
        ...
        $form->addElement(new Element_HTML("<legend>Logo Image Section</legend>"));
        $form->addElement(new Element_Hidden("controller", "work"));
        $form->addElement(new Element_Hidden("action", "worklogo"));
        ...
        $form->addElement(new Element_Hidden("isFront","L"));
       ...
       /* $form->addElement(new Element_File("Products Image: ", "master_plan", array(
        ...
        $form->addElement(new Element_File("Logo Image 1", "galleryImage", array(
            "placeholder" => "Video"
        )));
        
        $form->addElement(new Element_File("Logo Image 2 ", "galleryImage1", array(
            "placeholder" => "Video"
        )));
        
        $form->addElement(new Element_File("Logo Image 3 ", "galleryImage2", array(
            "placeholder" => "Video"
        )));
    ...
    function listData()
    {
        ...
        <script>
            $(document).ready(function () {
                var listURL = "helperfunc/worklogoList.php?workID=<?php echo $_REQUEST['workID']; ?>";
