...
//$form->addElement(new Element_HTML('<label>Note : width= 800px , height= 533px require jpg file</label>'));
	...
	{		
		...
		if(ets_db_num_rows($qry) > 0){
			...
			$form->addElement(new Element_HTML('<img src="'.DIR_WS_GALLERY_PATH.$rs['a_id']."/".$rs['gallery_image'].'" width="10%" height="10%" style="margin-left:200px;"><br>'));
//$form->addElement(new Element_HTML('<label>Note : width= 800px , height= 533px require jpg file</label>'));
			$form->addElement(new Element_File("Browse Image:", "gallery_image", array( 
			"placeholder" => "Browse Image"
			)));
