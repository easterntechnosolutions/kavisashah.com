...
class producttype
{
	function addForm()
	{
        ...
        $form->addElement(new Element_HTML('<label>Note : width= 1920px , height= 550px require jpg file</label>'));
		$form->addElement(new Element_File("Banner Image :", "projectfile", array(
	...
	{		
		...
		if(ets_db_num_rows($qry) > 0){
			...
			if($rs["projectFile"] != ""){
				...
				$form->addElement(new Element_HTML('<a href="'.$projectfile_path.'" target="_blank">View File</a><br>'));
