<?php
	...
	$queryString =  ets_db_query("SELECT * from download_brochure") or die(ets_db_error());	
		...
		while($res = ets_db_fetch_array($queryString)){
			...
			<a href="index.php?controller=products&action=inquirylist&subaction=delete&b_id='.$res['b_id'].'" title="Delete" class="btn btn-danger" onClick="return confirmSubmit();" ><i class="fa fa-times"></i></center></a></td>';
