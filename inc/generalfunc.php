...
function get_website_details()
{
	...
	$web_arr['address2'] = stripslashes($earr['address2']);
	$web_arr['address3'] = stripslashes($earr['address3']);
	$web_arr['address4'] = stripslashes($earr['address4']);
                                ...
                                <tbody>
                                    <tr valign="top">
                                        <td align="center" style="padding-top:30px">
                                            <a href="" target="_blank"><img src="'.MAIL_LOGO.'" height="50" width="310" border="0" alt="'.LOGO_ALT.'" style="display:block;color:#4c9ac9" align="middle" class="CToWUd"></a>
                                        </td>
                                    </tr>
                                    <tr>
                        ...
                        <td>
                            ...
                            <table width="800px" cellpadding="0" cellspacing="0" border="0" bgcolor="#ffffff" align="center">
                                <tbody>
                                    ...
                                    <tr>
                                        <td valign="top" style="padding-top:10px;font-family:Helvetica,Helvetica neue,Arial,Verdana,sans-serif;color:#707070;font-size:12px;line-height:18px;text-align:center;font-weight:none" align="center"><b> Contact No: </b> +91 982540772 | <b>Email</b> : info@korinoptoelectronics.com</td>
                                    </tr>
                        ...
                        <td>
                            ...
                            <table width="800px" cellpadding="0" cellspacing="0" border="0" bgcolor="#ffffff" align="center">
                                <tbody>
                                    ...
                                    <tr>
                                        <td valign="top" style="padding-top:10px;font-family:Helvetica,Helvetica neue,Arial,Verdana,sans-serif;color:#707070;font-size:12px;line-height:18px;text-align:center;font-weight:none" align="center">Copyright &copy;
                                            <?php echo date( "Y" ); ?>
                                             Korin Optoelectronics. All Rights Reserved. Designed by <a href="http://www.easternts.com.au" target="_blank">Eastern Techno Solutions</a></td>
                                    </tr>
                                </tbody>
                            </table>
                        </td>
